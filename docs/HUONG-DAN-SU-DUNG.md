# Hướng dẫn sử dụng — TaskFlow AI

Ứng dụng quản lý công việc (To-Do List) tích hợp AI, thiết kế tối giản. Tài liệu này hướng dẫn người dùng cuối sử dụng toàn bộ tính năng của ứng dụng.

---

## Mục lục
1. [Bắt đầu: Đăng ký & Đăng nhập](#1-bắt-đầu-đăng-ký--đăng-nhập)
2. [Màn hình chính (Danh sách công việc)](#2-màn-hình-chính-danh-sách-công-việc)
3. [Thêm & chỉnh sửa công việc](#3-thêm--chỉnh-sửa-công-việc)
4. [Thêm nhanh bằng AI (Quick Add)](#4-thêm-nhanh-bằng-ai-quick-add)
5. [Các bước con (Checklist)](#5-các-bước-con-checklist)
6. [Lịch tháng](#6-lịch-tháng)
7. [Lịch trình AI hàng ngày](#7-lịch-trình-ai-hàng-ngày)
8. [AI Coach — trợ lý cá nhân](#8-ai-coach--trợ-lý-cá-nhân)
9. [Thống kê & Biểu đồ](#9-thống-kê--biểu-đồ)
10. [Thiết lập & Giao diện Sáng/Tối](#10-thiết-lập--giao-diện-sángtối)
11. [Nhắc nhở & Thông báo](#11-nhắc-nhở--thông-báo)
12. [Widget màn hình chính](#12-widget-màn-hình-chính)
13. [Chế độ Offline](#13-chế-độ-offline)
14. [Câu hỏi thường gặp](#14-câu-hỏi-thường-gặp)

---

## 1. Bắt đầu: Đăng ký & Đăng nhập
...
## 2. Màn hình chính (Danh sách công việc)

Khu vực trên cùng là **thẻ chào mừng** hiển thị lời chào, số việc đang chờ và các nút nhanh:
...
## 3. Thêm & chỉnh sửa công việc

### Thêm nhanh (khuyến nghị)
Nhấn nút **+** (góc dưới phải) → mở **thanh tạo nhanh**:
...
## 4. Thêm nhanh bằng AI (Quick Add)

1. Nhấn **⭐** trên thẻ chào mừng.
2. Gõ một câu tự nhiên, ví dụ: *"Họp với sếp thứ 6 lúc 3h chiều"*.
3. Nhấn **Phân tích bằng AI** — AI tự tách thành tiêu đề, hạn chót, độ ưu tiên và **danh mục**.
4. Kiểm tra lại form đã điền sẵn rồi **Lưu**.

> Mẹo: mô tả càng rõ thời gian/độ ưu tiên thì AI điền càng chính xác.
...
## 7. Lịch trình AI hàng ngày

Tab **Kế hoạch** (thanh điều hướng dưới):
- AI tự sắp xếp các việc chưa hoàn thành thành **khung giờ** dựa trên độ ưu tiên, hạn chót và thói quen của bạn.
- Nhấn **⟳** (góc trên phải) để **tái tạo** lịch trình.
- Bấm vào một khung giờ để mở công việc tương ứng.

---

## 8. AI Coach — trợ lý cá nhân
...
## 10. Thiết lập & Giao diện Sáng/Tối
...
## 12. Widget màn hình chính

Đưa danh sách việc ra ngoài màn hình chính điện thoại:
...
**Không nhận được thông báo nhắc việc?**
→ Kiểm tra đã cấp quyền thông báo cho app, và công việc có đặt hạn chót chưa.
